...
- 같은 블록 줄 안에서 **하위 기간 막대가 상위 막대 안에 겹쳐** 그려집니다(연 안에 분기, 분기 안에 월). 하위에 블록을 따로 주면 그 블록 줄로 빠집니다.
...
- **막대 끌어 옮기기**: **좌우로 끌면 끈 만큼(하루 단위)** 기간이 옮겨지고 길이는 그대로입니다. 하위가 있으면 하위 사슬도 같은 날수만큼 함께 밀립니다. **양 끝을 끌면** 그쪽 끝만 움직여 기간이 늘거나 줄어듭니다. **다른 줄로 끌어** 막대 위에 놓으면 그 막대의 **하위계획**이 되고, 빈 자리에 놓으면 그 블록으로 옮겨집니다. 가로로만 끄는 동안에는 밑에 깔린 막대에 붙지 않습니다. 줄 높이가 낮아 끌기 어려운 **같은 줄 안에서는 편집창의 `상위 항목`**으로 고르면 됩니다.
