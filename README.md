...
- 막대를 누르면 이름 · 블록 · 영역 · 기간 · 진척률 편집과 `하위 추가`가 열리고, 막대 오른쪽 끝 `✕`로 바로 지웁니다. 하위가 있는 항목의 진척률은 하위 평균입니다. 편집창에서 **영역을 바꾸면** 하위 항목은 상위에서 빠져 그 영역의 최상위가 됩니다.
- **막대 끌어 옮기기**: **좌우로 끌면 끈 만큼(하루 단위)** 기간이 옮겨지고 길이는 그대로입니다. 하위가 있으면 하위 사슬도 같은 날수만큼 함께 밀립니다. **양 끝을 끌면** 그쪽 끝만 움직여 기간이 늘거나 줄어듭니다. **위아래로 끌어** 다른 막대에 놓으면 그 막대의 **하위계획**이 되고, 빈 블록 줄에 놓으면 그 블록으로 옮겨집니다(가로로만 끄는 동안에는 밑에 깔린 막대에 붙지 않습니다).
