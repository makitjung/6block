...
- 막대를 누르면 이름 · 기간 · 진척률 편집과 `하위 추가`가 열립니다. 하위가 있는 항목의 기간·진척률은 하위에서 자동 계산됩니다.
...
임시 폴더에 새 DB를 만들고 127.0.0.1:8011에 테스트 서버를 띄워 실제 HTTP 요청으로 63개 항목을
...
하루 골격 생성의 멱등성, 필드 자동저장, 블록 시간 변경 시 장소 보존, 장기 계획 막대(추가·하위·자동 롤업·겹침·삭제),
